...
<tr>
<td style="color:#399fb5;font-weight:bold;">Username : <input type="text" name="uname"  required /></td>
</tr>
<tr>
...
<tr>
<td><button type="submit" name="btn-signup" style="margin:10px 0px 10px 80px;color:#399fb5;font-weight:bold">Sign Me Up</button></td>
</tr>
<tr>
<td><a href="signin.php" style="margin:10px 0px 10px 80px;color:#399fb5;font-weight:bold">Sign In Here</a></td>
</tr>
</table>
</form>
</div>
